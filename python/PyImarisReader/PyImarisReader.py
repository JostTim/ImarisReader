...
class bpReaderTypesC_DataTypeVector(Structure):
    _fields_ = [("mDataTypes", bpReaderTypesC_DataTypePtr), ("mDataTypesSize", c_uint)]
...
class bpReaderTypesC_Size5DVector(Structure):
    _fields_ = [
        ("mSizePerResolution", POINTER(bpReaderTypesC_Size5D)),
...
class bpReaderTypesC_TimeInfo(Structure):
    _fields_ = [("mJulianDay", c_uint), ("mNanosecondsOfDay", c_ulonglong)]
...
class bpReaderTypesC_TimeInfos(Structure):
    _fields_ = [("mValues", bpReaderTypesC_TimeInfoPtr), ("mValuesSize", c_uint)]
...
class bpReaderTypesC_ColorInfos(Structure):
    _fields_ = [("mValues", bpReaderTypesC_ColorInfoPtr), ("mValuesSize", c_uint)]
...
class bpReaderTypesC_Parameter(Structure):
    _fields_ = [("mName", bpReaderTypesC_String), ("mValue", bpReaderTypesC_String)]
...
class bpReaderTypesC_Parameters(Structure):
    _fields_ = [
        ("mValues", bpReaderTypesC_ParameterSectionPtr),
        ("mValuesCount", c_uint),
    ]
...
class bpReaderTypesC_IndexTCR(Structure):
    _fields_ = [("mT", c_uint), ("mC", c_uint), ("mR", c_uint)]
...
class FileImagesInfo:
    def __init__(self, input_filename: str, aSWMR: bool):
        self._load_dll()
    ...
    def GetFileImagesInformation(self):
        self.mcdll.bpImageReaderC_GetFileImagesInformation.argtypes = [
            bpReaderTypesC_String,
            c_bool,
        ]
        self.mcdll.bpImageReaderC_GetFileImagesInformation.restype = (
            bpReaderTypesC_DataTypeVectorPtr
        )
        dataTypes = self.mcdll.bpImageReaderC_GetFileImagesInformation(
            self.mInputFilename, self.mSWMR
        )
        dataTypes_py = []
...
class ImageReaderUInt8:
    def __init__(self, input_filename: str, image_index: int, options: Options):
        self._load_dll()
        self._store_filename(input_filename)
    ...
    def _create(self):
        self.mcdll.bpImageReaderC_CreateUInt8.argtypes = [
            bpReaderTypesC_String,
            c_uint,
            bpReaderTypesC_OptionsPtr,
        ]
        self.mcdll.bpImageReaderC_CreateUInt8.restype = bpImageReaderCPtr
        self.mImageReaderPtr = self.mcdll.bpImageReaderC_CreateUInt8(
            self.mInputFilename, self.mImageIndex, self.mOptions
        )

    def ReadData(self, begin: Index5D, end: Index5D, resolution_index: int, buffer):
        self.mcdll.bpImageReaderC_ReadDataUInt8.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Index5DPtr,
            bpReaderTypesC_Index5DPtr,
            c_uint,
            POINTER(bpReaderTypesC_UInt8),
        ]
        self.mcdll.bpImageReaderC_ReadDataUInt8.restype = None
        self.mcdll.bpImageReaderC_ReadDataUInt8(
            self.mImageReaderPtr,
            begin.get_c_index5D(),
            end.get_c_index5D(),
            resolution_index,
            buffer,
    ...
    def ReadMetadata(self):
        ...
        blockSizePerResolution = bpReaderTypesC_Size5DVectorPtr(
            bpReaderTypesC_Size5DVector()
        )
        ...
        self.mcdll.bpImageReaderC_ReadMetadataUInt8.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_ImageExtentPtr,
            bpReaderTypesC_TimeInfosPtr,
            bpReaderTypesC_ColorInfosPtr,
            tCompressionAlgorithmTypePtr,
        ]
        self.mcdll.bpImageReaderC_ReadMetadataUInt8.restype = None
        self.mcdll.bpImageReaderC_ReadMetadataUInt8(
            self.mImageReaderPtr,
            imageSizePerResolution,
            blockSizePerResolution,
            imageExtents,
            timeInfos,
            colorInfos,
            compression,
        ...
        for res in range(imageSizePerResolution.contents.mSizePerResolutionSize):
            image_size = Size5D(
                imageSizePerResolution.contents.mSizePerResolution[res].mValueX,
            ...
            block_size = Size5D(
                blockSizePerResolution.contents.mSizePerResolution[res].mValueX,
        ...
        imageExtents_py = ImageExtents(
            imageExtents.contents.mExtentMinX,
            imageExtents.contents.mExtentMinY,
            imageExtents.contents.mExtentMinZ,
            imageExtents.contents.mExtentMaxX,
            imageExtents.contents.mExtentMaxY,
            imageExtents.contents.mExtentMaxZ,
        )
        timeInfos_py = []
        for t in range(timeInfos.contents.mValuesSize):
            timepoint_info = TimeInfo(
                timeInfos.contents.mValues[t].mJulianDay,
                timeInfos.contents.mValues[t].mNanosecondsOfDay,
            )
            timeInfos_py.append(timepoint_info)
        colorInfos_py = []
        for ch in range(colorInfos.contents.mValuesSize):
            channel_info = ColorInfo(
                colorInfos.contents.mValues[ch].mIsBaseColorMode,
            ...
            if channel_info.mIsBaseColorMode:
                channel_info.mBaseColor = Color(
                    colorInfos.contents.mValues[ch].mBaseColor.mRed,
                ...
                channel_info.mColorTableSize = colorInfos.contents.mValues[
                    ch
                ].mColorTableSize
                for i in range(colorInfos.contents.mValues[ch].mColorTableSize):
                    color = Color(
                        colorInfos.contents.mValues[ch].mColorTable[i].mRed,
        ...
        self.FreeMetadata(
            imageSizePerResolution, blockSizePerResolution, timeInfos, colorInfos
        )
        return (
            imageSizePerResolution_py,
            blockSizePerResolution_py,
    ...
    def FreeMetadata(
        ...
        imageSizePerResolution: bpReaderTypesC_Size5DVectorPtr,
        blockSizePerResolution: bpReaderTypesC_Size5DVectorPtr,
        timeInfos: bpReaderTypesC_TimeInfosPtr,
        colorInfos: bpReaderTypesC_ColorInfosPtr,
    ):
        self.mcdll.bpImageReaderC_FreeMetadata.argtypes = [
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_TimeInfosPtr,
            bpReaderTypesC_ColorInfosPtr,
        ...
        self.mcdll.bpImageReaderC_FreeMetadata(
            imageSizePerResolution, blockSizePerResolution, timeInfos, colorInfos
        )

    def ReadParameters(self):
        parameters = bpReaderTypesC_ParametersPtr(bpReaderTypesC_Parameters())
        self.mcdll.bpImageReaderC_ReadParametersUInt8.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_ParametersPtr,
        ]
        ...
        for i in range(parameters.contents.mValuesCount):
            for j in range(parameters.contents.mValues[i].mValuesCount):
                parameters_py.set_value(
                    parameters.contents.mValues[i].mName.decode("utf-8"),
                    parameters.contents.mValues[i].mValues[j].mName.decode("utf-8"),
                    parameters.contents.mValues[i]
                    .mValues[j]
                    .mValue.decode("utf-8", errors="replace"),
                )
        self.FreeParameters(parameters)
        return parameters_py

    def FreeParameters(self, parameters: bpReaderTypesC_ParametersPtr):
        self.mcdll.bpImageReaderC_FreeParameters.argtypes = [
            bpReaderTypesC_ParametersPtr
        ]
    ...
    def ReadHistogram(self, index: IndexTCR):
        self.mcdll.bpImageReaderC_ReadHistogramUInt8.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_IndexTCRPtr,
        ]
        self.mcdll.bpImageReaderC_ReadHistogramUInt8.restype = (
            bpReaderTypesC_HistogramPtr
        )
        return self.mcdll.bpImageReaderC_ReadHistogramUInt8(
            self.mImageReaderPtr, index.get_c_indexTCR()
        )

    def ReadThumbnail(self):
        self.mcdll.bpImageReaderC_ReadThumbnailUInt8.argtypes = [bpImageReaderCPtr]
        self.mcdll.bpImageReaderC_ReadThumbnailUInt8.restype = (
            bpReaderTypesC_ThumbnailPtr
        )
...
class ImageReaderUInt16:
    ...
    def _create(self):
        self.mcdll.bpImageReaderC_CreateUInt16.argtypes = [
            bpReaderTypesC_String,
            c_uint,
            bpReaderTypesC_OptionsPtr,
        ]
        self.mcdll.bpImageReaderC_CreateUInt16.restype = bpImageReaderCPtr
        self.mImageReaderPtr = self.mcdll.bpImageReaderC_CreateUInt16(
            self.mInputFilename, self.mImageIndex, self.mOptions
        )

    def ReadData(self, begin: Index5D, end: Index5D, resolution_index: int, buffer):
        self.mcdll.bpImageReaderC_ReadDataUInt16.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Index5DPtr,
            bpReaderTypesC_Index5DPtr,
            c_uint,
            POINTER(bpReaderTypesC_UInt16),
        ]
        self.mcdll.bpImageReaderC_ReadDataUInt16.restype = None
        self.mcdll.bpImageReaderC_ReadDataUInt16(
            self.mImageReaderPtr,
            begin.get_c_index5D(),
            end.get_c_index5D(),
            resolution_index,
    ...
    def ReadMetadata(self):
        ...
        colorInfos = bpReaderTypesC_ColorInfosPtr(bpReaderTypesC_ColorInfos())
        compression = tCompressionAlgorithmTypePtr(tCompressionAlgorithmType(0))
        self.mcdll.bpImageReaderC_ReadMetadataUInt16.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_ImageExtentPtr,
        ...
        self.mcdll.bpImageReaderC_ReadMetadataUInt16(
            self.mImageReaderPtr,
            imageSizePerResolution,
            blockSizePerResolution,
            imageExtents,
    ...
    def ReadParameters(self):
        parameters = bpReaderTypesC_ParametersPtr(bpReaderTypesC_Parameters())
        self.mcdll.bpImageReaderC_ReadParametersUInt16.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_ParametersPtr,
        ]
    ...
    def ReadHistogram(self, index: IndexTCR):
        self.mcdll.bpImageReaderC_ReadHistogramUInt16.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_IndexTCRPtr,
        ]
        self.mcdll.bpImageReaderC_ReadHistogramUInt16.restype = (
            bpReaderTypesC_HistogramPtr
        )
        return self.mcdll.bpImageReaderC_ReadHistogramUInt16(
            self.mImageReaderPtr, index.get_c_indexTCR()
        )

    def ReadThumbnail(self):
        self.mcdll.bpImageReaderC_ReadThumbnailUInt16.argtypes = [bpImageReaderCPtr]
        self.mcdll.bpImageReaderC_ReadThumbnailUInt16.restype = (
            bpReaderTypesC_ThumbnailPtr
        )
...
class ImageReaderUInt32:
    ...
    def _create(self):
        self.mcdll.bpImageReaderC_CreateUInt32.argtypes = [
            bpReaderTypesC_String,
            c_uint,
            bpReaderTypesC_OptionsPtr,
        ]
        self.mcdll.bpImageReaderC_CreateUInt32.restype = bpImageReaderCPtr
        self.mImageReaderPtr = self.mcdll.bpImageReaderC_CreateUInt32(
            self.mInputFilename, self.mImageIndex, self.mOptions
        )

    def ReadData(self, begin: Index5D, end: Index5D, resolution_index: int, buffer):
        self.mcdll.bpImageReaderC_ReadDataUInt32.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Index5DPtr,
            bpReaderTypesC_Index5DPtr,
            c_uint,
            POINTER(bpReaderTypesC_UInt32),
        ]
        self.mcdll.bpImageReaderC_ReadDataUInt32.restype = None
        self.mcdll.bpImageReaderC_ReadDataUInt32(
            self.mImageReaderPtr,
            begin.get_c_index5D(),
            end.get_c_index5D(),
            resolution_index,
    ...
    def ReadMetadata(self):
        ...
        colorInfos = bpReaderTypesC_ColorInfosPtr(bpReaderTypesC_ColorInfos())
        compression = tCompressionAlgorithmTypePtr(tCompressionAlgorithmType(0))
        self.mcdll.bpImageReaderC_ReadMetadataUInt32.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_ImageExtentPtr,
        ...
        self.mcdll.bpImageReaderC_ReadMetadataUInt32(
            self.mImageReaderPtr,
            imageSizePerResolution,
            blockSizePerResolution,
            imageExtents,
    ...
    def ReadParameters(self):
        parameters = bpReaderTypesC_ParametersPtr(bpReaderTypesC_Parameters())
        self.mcdll.bpImageReaderC_ReadParametersUInt32.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_ParametersPtr,
        ]
    ...
    def ReadHistogram(self, index: IndexTCR):
        self.mcdll.bpImageReaderC_ReadHistogramUInt32.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_IndexTCRPtr,
        ]
        self.mcdll.bpImageReaderC_ReadHistogramUInt32.restype = (
            bpReaderTypesC_HistogramPtr
        )
        return self.mcdll.bpImageReaderC_ReadHistogramUInt32(
            self.mImageReaderPtr, index.get_c_indexTCR()
        )

    def ReadThumbnail(self):
        self.mcdll.bpImageReaderC_ReadThumbnailUInt32.argtypes = [bpImageReaderCPtr]
        self.mcdll.bpImageReaderC_ReadThumbnailUInt32.restype = (
            bpReaderTypesC_ThumbnailPtr
        )
...
class ImageReaderFloat:
    ...
    def _create(self):
        self.mcdll.bpImageReaderC_CreateFloat.argtypes = [
            bpReaderTypesC_String,
            c_uint,
            bpReaderTypesC_OptionsPtr,
        ]
        self.mcdll.bpImageReaderC_CreateFloat.restype = bpImageReaderCPtr
        self.mImageReaderPtr = self.mcdll.bpImageReaderC_CreateFloat(
            self.mInputFilename, self.mImageIndex, self.mOptions
        )

    def ReadData(self, begin: Index5D, end: Index5D, resolution_index: int, buffer):
        self.mcdll.bpImageReaderC_ReadDataFloat.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Index5DPtr,
            bpReaderTypesC_Index5DPtr,
            c_uint,
            POINTER(bpReaderTypesC_Float),
        ]
        self.mcdll.bpImageReaderC_ReadDataFloat.restype = None
        self.mcdll.bpImageReaderC_ReadDataFloat(
            self.mImageReaderPtr,
            begin.get_c_index5D(),
            end.get_c_index5D(),
            resolution_index,
    ...
    def ReadMetadata(self):
        ...
        colorInfos = bpReaderTypesC_ColorInfosPtr(bpReaderTypesC_ColorInfos())
        compression = tCompressionAlgorithmTypePtr(tCompressionAlgorithmType(0))
        self.mcdll.bpImageReaderC_ReadMetadataFloat.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_Size5DVectorPtr,
            bpReaderTypesC_ImageExtentPtr,
        ...
        self.mcdll.bpImageReaderC_ReadMetadataFloat(
            self.mImageReaderPtr,
            imageSizePerResolution,
            blockSizePerResolution,
            imageExtents,
    ...
    def ReadParameters(self):
        parameters = bpReaderTypesC_ParametersPtr(bpReaderTypesC_Parameters())
        self.mcdll.bpImageReaderC_ReadParametersFloat.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_ParametersPtr,
        ]
    ...
    def ReadHistogram(self, index: IndexTCR):
        self.mcdll.bpImageReaderC_ReadHistogramFloat.argtypes = [
            bpImageReaderCPtr,
            bpReaderTypesC_IndexTCRPtr,
        ]
        self.mcdll.bpImageReaderC_ReadHistogramFloat.restype = (
            bpReaderTypesC_HistogramPtr
        )
        return self.mcdll.bpImageReaderC_ReadHistogramFloat(
            self.mImageReaderPtr, index.get_c_indexTCR()
        )

    def ReadThumbnail(self):
        self.mcdll.bpImageReaderC_ReadThumbnailFloat.argtypes = [bpImageReaderCPtr]
        self.mcdll.bpImageReaderC_ReadThumbnailFloat.restype = (
            bpReaderTypesC_ThumbnailPtr
        )
